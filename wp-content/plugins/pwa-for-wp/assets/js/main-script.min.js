...
jQuery(document).ready(function($){
    ...
    jQuery(".pwaforwp-screenshots-upload").click(function(e) {  // Application screenshots upload
        ...
        .on("select", function() {
            var attachment = pwaforwpMediaUploader.state().get("selection").first().toJSON();
            jQuery(".pwaforwp-screenshots").val(attachment.url);
        })
        .open();
    });
...
function PWAforwpreadCookie(name) {
    ...
    */
    ...
    jQuery("#pwaforwp_settings_offline_page").on("change", function(e){
        var selfp = jQuery(this);
        if(selfp.val()=='other'){
...
function get_include_pages(){
    ...
    jQuery(".visibility-loader").css("display","flex");
    ...
    jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (jd.success == 1) {
                    ...
                    jQuery(".visibility-loader").css("display","none");
                    // console.log(response);
                } else {
                    //alert(response.message)
                }
