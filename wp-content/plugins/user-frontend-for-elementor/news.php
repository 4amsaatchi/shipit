...
if( !class_exists( 'CC_News' ) ) {

    class CC_News {

        protected $submenu_slug = 'edit.php?post_type=fael_form';
        protected $post_type = 'fael_form';
        ...
        public function __construct() {
            ...
            add_action( 'wp_ajax_sm_dissmiss_news_notice', array( $this, 'dissmiss_news_notice' ) );
        }

        public function dissmiss_news_notice() {
            $notices = $this->get_notice('cc_admin_notices' );
            ...
            if ( update_option( 'cc_admin_notices', $notices ) ) {
        ...
        public function add_news_page() {
            add_submenu_page ( $this->submenu_slug, 'News', 'News', 'manage_options', __FILE__, array( $this, 'generate_news_page_content' ) );
        }
        ...
        function get_notice ( $notice_name =  'cc_admin_notices'  ) {
