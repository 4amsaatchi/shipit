 ...
 * @since 1.0.0
 */
class FAEL_Checkbox extends FAEL_Widget_Base {
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new FAEL_Checkbox() );
