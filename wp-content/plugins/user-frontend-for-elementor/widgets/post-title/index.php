 ...
 * @since 1.0.0
 */
class FAEL_Post_Title extends FAEL_Widget_Base {
    ...
    protected function render() {
        ...
        <div id="<?php echo $s['element_id']; ?>" class="position-relative form-group <?php echo $s['element_class']; ?>">
            ...
            <input type="text"
                   name="<?php echo $s['form_handle']; ?>[<?php echo 'post_title'; ?>]"
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new FAEL_Post_Title() );
