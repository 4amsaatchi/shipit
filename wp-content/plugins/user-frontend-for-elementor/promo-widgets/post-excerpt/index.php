 ...
 * @since 1.0.0
 */
class FAEL_Post_Excerpt extends FAEL_Widget_Base {
    ...
    public function get_title() {
        return __( 'UF Post EXCERPT <span class="fael_promo_text" style="color: red;">(Pro)</span>', 'fael' );
    }
     ...
     *
     * Retrieve the list of categories the FAEL_Post_Excerpt widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new FAEL_Post_Excerpt() );
