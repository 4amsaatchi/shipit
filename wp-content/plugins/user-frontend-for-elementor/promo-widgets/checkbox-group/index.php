 ...
 * @since 1.0.0
 */
class FAEL_Checkbox_Group extends FAEL_Widget_Base {
    ...
    public function get_title() {
        return __( 'UF Checkbox Group <span class="fael_promo_text" style="color: red;">(Pro)</span>', 'fael' );
    }
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new FAEL_Checkbox_Group() );
