 ...
 * @since 1.0.0
 */
class FAEL_Plugin_List extends FAEL_Widget_Base {
    ...
    public function get_title() {
        return __( 'FA Plugin List <span class="fael_promo_text" style="color: red;">(Pro)</span>', 'fael' );
    }
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new FAEL_Plugin_List() );
